...
/**
 * Filtro JWT que intercepta las peticiones HTTP para validar tokens JWT
 * Se ejecuta una vez por petición y establece la autenticación en el contexto de seguridad
 */
@Component
